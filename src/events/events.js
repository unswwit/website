          ...
          <div id="past-events" className="grid-container">
            <div className="grid-item">
              <img
                ...
                src={
                  process.env.PUBLIC_URL +
                  "./event-covers/ey-excel-workshop.jpg"
                }
            ...
            <div className="grid-item">
              <img
                ...
                src={
                  process.env.PUBLIC_URL +
                  "./event-covers/sandbox-portfolio.png"
                }
            ...
            <div className="grid-item">
              <img
                ...
                src={
                  process.env.PUBLIC_URL +
                  "./event-covers/imposter-syndrome.jpg"
                }
            ...
            <div className="grid-item">
              <img
                className="event-images"
                src={
                  process.env.PUBLIC_URL + "./event-covers/csesoc-penpals.jpg"
                }
            ...
            <div className="grid-item">
              <img
                className="event-images"
                src={
                  process.env.PUBLIC_URL + "./event-covers/robogals-games.jpg"
                }
            ...
            <div className="grid-item">
              <img
                ...
                src={
                  process.env.PUBLIC_URL +
                  "./event-covers/online-games-night.jpg"
                }
            ...
            <div className="grid-item">
              <img
                className="event-images"
                src={
                  process.env.PUBLIC_URL + "./event-covers/10-hoodie-comp.png"
                }
            ...
            <div className="grid-item">
              <img
                ...
                src={
                  process.env.PUBLIC_URL +
                  "./event-covers/09-csesoc-comp1511.gif"
                }
            ...
            <div className="grid-item">
              <img
                className="event-images"
                src={
                  process.env.PUBLIC_URL + "./event-covers/02-witxmathsoc.gif"
                }
                alt="nintendo & chill"
              />
            </div>
