            ...
            <div className="upcoming">
              <div>
                ...
                <div className="event-description">
                  <p className="event-name">WIT x Forage presents: Personal Branding Workshop</p>
                  <p className="event-date">11th November 2020, 6-7:00 PM</p>
                  <p className="event-summary">
										Are you interested in building your own personal brand, making valuable
										connections and conquering small talk? {' '}
                    <span role="img" aria-label="graph">
											🗣️
                    </span>{' '}
										Fear not, UNSW Women in Technology is collaborating with Forage (formerly
										InsideSherpa) to provide an insightful introduction into the tips and tricks
										involved in successful networking and personal branding.  Don’t miss out on this
										opportunity to engage with our lovely industry representatives in developing the
										soft skills that will set you apart from the rest! {' '}
                    <span role="img" aria-label="graph">
											✔️✔️
                    </span>
										So come along and learn to tell your story and kickstart your career! Please
										note this is a 𝗰𝗼𝗺𝗽𝘂𝗹𝘀𝗼𝗿𝘆 event for all WIT Empowerment Program
										Mentees
                  </p>
                  <ul id="links">
                    <li className="event-link">
                      <a href="https://forms.gle/VuFjVp6sTNGC5QT78" className="event">
												Register
                      </a>
                    </li>
                    <li className="event-link">
