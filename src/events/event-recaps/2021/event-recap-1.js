...
import "../../.././style.css";
import styles from ".././event-recaps.module.css";
import PageHeader from "../../.././header";

class eventRecap1 extends Component {
  ...
  render() {
    return (
      <div>
        ...
        {/*Start of eventRecap post*/}
        <div className={styles.eventRecapContent}>
          <div>
            <h2 className={styles.eventRecapTitle}>The Small, the Powerful…The Byte</h2>
            <div className={styles.eventRecapDetails}>
