    ...
    <div>
      ...
      <div className={styles.ourStory}>
        <p className={styles.ourmascotContent}>
          ...
          and the codey kind) and believes in empowering all creatures. Willow
          is only four years old but she understands the power of nurturing
          young creatures and showing them how to navigate the forest. When
          she’s not burrowed under the desk having a quick snooze, she can be
          found munching on a shrub salad and cheering on the WIT team in
          everything they do.
        </p>
        <p className={styles.ourmascotContent}>
          Willow debuted as WIT’s mascot in 2020, and has been bringing laughter
          and motivation to our community ever since! In 2021, Willow was
          brought to life from the screen to O-Week as a handmade crocheted
          plushie. Through a&nbsp;
          <a
