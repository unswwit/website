    ...
    <div className={styles.paper}>
      ...
      <div className={styles.textBlock}>
        <img
          ...
          alt={sponsorName}
        />
        <h1 className={styles.sponsorType}>{sponsors[sponsorName][3]} SPONSOR</h1>
        <div className={styles.inLine}>
          <p className={styles.sponsorWebsite}>Website: </p>
          <a className={styles.sponsorLink} href={sponsors[sponsorName][1]} target="_blank" rel="noopener noreferrer">
