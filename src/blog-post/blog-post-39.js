...
class blogPost39 extends Component {
  ...
  render() {
    return (
      <div>
        {/* Cover Photo */}
        <PageHeader imgUrl="/headers/blog-header.jpg" title="Blog Post #39" />
        ...
        <div className={styles.blogContent}>
          <div>
            <h2 className={styles.blogTitle}>How to Take Notes Effectively, Professionally, and Academically</h2>
          ...
          <div className={styles.post}>
            ...
            <ul className={styles.list}>
              <li className={styles.postContent}>Identify the speaker’s purpose</li>
              <li className={styles.postContent}>
								Write down the main points, essence, and notable facts that would be hard to recall on
								your own later
              </li>
              <li className={styles.postContent}>To save time, use abbreviations.</li>
              <li className={styles.postContent}>
								To add organization, use bullets, highlight, underline and capitalize appropriately
              </li>
              <li className={styles.postContent}>Use arrows to show how concepts are connected</li>
              <li className={styles.postContent}>
            ...
            <p className={styles.question}>Things to avoid while note-taking:</p>
            <p className={styles.postContent}>Do not:</p>
            <ul className={styles.list}>
              <li className={styles.postContent}>Write down everything the lecturer/speaker says</li>
              <li className={styles.postContent}>Multitask. Stay focused on the speaker</li>
              <li className={styles.postContent}>
