        ...
        <div className="blog-content">
          ...
          <div className="post">
            ...
            <ul className="list">
              ...
              <li className="post-content">Write down the main points, essence, and notable facts that would 
              be hard to recall on your own later</li>
              <li className="post-content">To save time, use abbreviations.</li>
              <li className="post-content">To add organization, use bullets, highlight, underline and capitalize 
              appropriately</li>
              <li className="post-content">Use arrows to show how concepts are connected</li>
              <li className="post-content">Create easily identifiable symbols such as stars to identify action 
              items etc</li>
            ...
            <ul className="list">
              ...
              <li className="post-content">Experiment with the presentation or organization of your notes while 
              taking notes. Determine the style, organization, and method before taking notes. Remember to 
              always open to trying out a new style of taking notes but plan.</li>
            </ul>
            <br />
            ...
            <p className="post-content">
              ...
              a section for the summary where you summarise the key point using your own words. During the lecture, you add 
            ...
            <p className="post-content">
              ...
              write down words, phrases, and main ideas into the appropriate category.
            </p>
            <br />
            <p className="post-content">
              Now, you have some new methods, tips, and tools to help you write notes effectively and efficiently for school or your 
              professional life! 
            </p>
            <br />
          </div>
