    ...
    return (
      <div>
        ...
        <div className="blog-content">
          <div>
            <h2 className="blog-title">Which technology degree are you?</h2>
            <p className="date">2nd August 2020</p>
          </div>
          ...
          <div className="post">
            ...
            <ol className="list" type="1">
              <li className="question">Finish the word, mother-</li>
              <br />
              ...
              <li className="question">Project-wise you would manage:</li>
              <br />
              <ol className="list" type="a">
                <li>Product</li>
                <br />
              ...
              <li className="question">Pick a letter:</li>
              <br />
              <ol className="list" type="a">
                <li>A</li>
                <br />
              ...
              <li className="question">You walk over a sewer grate, do you…</li>
              <br />
              <ol className="list" type="a">
            ...
            <p className="super-emph">THE RESULTS</p>
            <br />
