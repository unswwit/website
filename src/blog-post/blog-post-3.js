            ...
            <div>
              ...
              <div class="blog-content">
                ...
                <div class="post">
                    ...
                    <p class="post-content">In this week’s blog, we take a look at 4 lessons we can learn from her amazing life, and how she continues to redefine technology as we know it today.</p><br/>
                    ...
                    <ol>
                      ...
                      <br/>
                      <li class = "list"> Pursuing a role that she didn’t feel totally prepared for, a role that would challenge her, pushing her out of her comfort zone, thus allowing her to grow personally and professionally.</li>
                    </ol> <br/>


                    <p class="question">Lesson 3: Dealing with Scrutiny
</p><br/>

                    <p class = "post-content">Our daring goals in life, though exciting for us, are often matched with scrutiny from others.
</p>
                    <p class = "post-content">For Mayer, this arises when she began working as a CEO at Yahoo!</p>
                    <p class = "post-content">Instead of receiving support as a female executive who was working in a male-dominated industry, she found criticism. Instead of receiving optimism for new ideas, she was handed pessimism.</p>
                    <p class = "post-content">As she redefined business models, strategizing for both the company’s short and long term goals, and implementing new initiatives in response to the constant disruption in the tech industry (for the better), the media took the opportunity to slam and criticize her decisions as well as her work ethic.</p>
                    <p class = "post-content">But Mayer didn’t let it phase her. Instead, she took the progressive side of the criticism, pulling out valuable feedback that had been made, and was motivated by it to keep achieving more.</p>

                    <br/>
                    <p class = "question">Lesson 4: The Daring Side of Reinventing </p> <br/>
                    <p class = "post-content">Starting something brand-new, challenging the convention, and fear of failure is something we all grapple with.</p>
                    <p class = "post-content">Mayer’s work at Google began as the internet began to change the world. She designed Google’s search interface, was involved in major product management including Gmail, and developed systems for customising searches on Google.</p>
                    <p class = "post-content">Motivating her team at Yahoo! to achieve success was challenging. Instead of attempting to fix the declining lines of business, she led her team to recreate them, investing in mobile apps at the brink of their popularity. Redesigning a major company was a huge risk and although Yahoo! was later sold to Verizon, Mayer was a fundamental key in its future success.</p>
