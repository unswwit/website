                  ...
                  <Image
                    ...
                    src={
                      ...
                      window.matchMedia("(prefers-color-scheme: dark)").matches
                        ? `${process.env.PUBLIC_URL}/sponsors/2022/dark-mode/${sponsors[key][2]}`
                        : `${process.env.PUBLIC_URL}/sponsors/2022/${sponsors[key][2]}`
                    }
                    alt={key}
                    onClick={() => {
                      setOpen(true);
                    ...
                    <Image
                      ...
                      src={
                        ...
                        window.matchMedia("(prefers-color-scheme: dark)")
                          .matches
                          ? `${process.env.PUBLIC_URL}/affiliations/dark-mode/${affiliations[key][1]}`
                          : `${process.env.PUBLIC_URL}/affiliations/${affiliations[key][1]}`
                      }
                      alt={key}
                    />
                  </a>
                  ...
                  >
                    <Image
                      ...
                      src={
                        ...
                        window.matchMedia("(prefers-color-scheme: dark)")
                          .matches
                          ? `${process.env.PUBLIC_URL}/partnerships/dark-mode/${partnerships[key][1]}`
                          : `${process.env.PUBLIC_URL}/partnerships/${partnerships[key][1]}`
                      }
                      alt={key}
                    />
                  </a>
