...
import EpisodeTemplate from "../../../components/EpisodeTemplate.js";
...
const EpisodePage = (props) => {
  ...
  useEffect(() => {
    ...
    console.log(currEpisodeNo)

    // importing transcript
    let tempTranscript = "";
    try {
      tempTranscript = require(`../../../public/podcast-transcripts/podcast-episode-${currEpisodeNo}.md`);
                  ...
                  return (
                    ...
                    >
                      <img
                        ...
                        src={`/podcast-logos/${logos[platform]}`}
                        alt={platform}
                        width="25px"
                        height="25px"
                      />
